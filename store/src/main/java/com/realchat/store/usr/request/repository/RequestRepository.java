...
public interface RequestRepository {
	...
	//Friend Request
	public UserFriendRequest addFriendRequest(@Param("sender_id") String sender_id, @Param("receiver_id") String receiver_id) throws Exception;
	...
	public UserFriendRequest updateFriendRequest(UserFriendRequest UserFriendRequest) throws Exception;
